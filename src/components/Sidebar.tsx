...
const navItems = [
  ...
  { href: "/blockers", label: "Blockers", icon: "M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" },
  ...
  return (
    <aside className="w-64 bg-gray-900 text-white min-h-screen flex flex-col">
      <div className="p-4 border-b border-gray-800">
        <h1 className="text-xl font-bold">SprintOps</h1>
        {session?.user?.teamName && (
          <p className="text-sm text-gray-400 mt-1">{session.user.teamName}</p>
        )}
      </div>
